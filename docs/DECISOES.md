...
### D-15 · O console de administração mostra o que se decide, não o que se configura
...
| Q8 | Qual o custo unitário real por produto Atlassian hoje? | João / financeiro | **Só o valor** — desde `D-15` há um campo de preço por produto do inventário no console, sem deploy. RF-53 (custo mensal e assentos ociosos) |
