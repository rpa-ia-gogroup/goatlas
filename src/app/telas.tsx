...
export function ReciboConfirmacao({
  ...
  /**
   * 🚨 **O que a conversa JÁ anexou** — `D-69`.
   *
  ...
  //
  // ⚠️ `jaEnviados` desliga a pendência (`D-69`): arquivo enviado É a resposta, e o servidor
...
function FormularioEmCurso({
  ...
  return (
    <form className="pilha" onSubmit={enviar}>
      ...
      {/* `D-69` — aqui `jaEnviados` fica no default vazio de propósito: a chave nasce
