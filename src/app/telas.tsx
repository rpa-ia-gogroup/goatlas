...
export function ReciboConfirmacao({
  ...
  /**
   * 🚨 **O que a conversa JÁ anexou** — `D-68`.
   *
  ...
  //
  // ⚠️ `jaEnviados` desliga a pendência (`D-68`): arquivo enviado É a resposta, e o servidor
...
function FormularioEmCurso({
  ...
  return (
    <form className="pilha" onSubmit={enviar}>
      ...
      {/* `D-68` — aqui `jaEnviados` fica no default vazio de propósito: a chave nasce
